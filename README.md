...
| Art — NPCs (0/15), trees/rocks (8/11) | All 8 region trees are sourced; the 3 rocks and all 15 NPC portraits have no source match found anywhere yet — see `docs/ASSET_SOURCING.md` |
