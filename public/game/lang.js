...
const EXACT = {
  ...
  'Quách Đại Hiệp': 'Great Hero Guo', 'Môn Khách': 'Retainer',
  ...
  'Mỗi Axie sinh ra mang một tia sáng riêng — mười sáu mảnh vỏ trứng úp sấp, chờ nứt ra vận mệnh của ngươi.': 'Every Axie is born carrying its own spark — sixteen eggshells lie face-down, waiting to crack open your fate.',
  'Bấm để đập vỏ': 'Tap to crack a shell',
  ', đọc vận mệnh bẩm sinh, rồi': ', read your innate fate, then',
  'chọn đúng 3 mảnh': 'choose exactly 3 shards',
  'mang theo suốt hành trình!': 'to carry through the journey!',
  ...
  'Nở ngẫu nhiên tên gọi': 'Hatch a random name',
...
Object.assign(EXACT, {
  ...
  'Phiêu Vân Bộ (nhảy 2 lần trên không)': 'Cloud-Drifting Steps (double-jump in midair)',
