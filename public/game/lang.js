...
const EXACT = {
  ...
  'Molt Cảnh': 'Molt Realm', 'Radiant Core Cảnh': 'Radiant Core Realm', 'Starforged Cảnh': 'Starforged Realm',
  'Resonance · Trung Kỳ': 'Resonance · Mid', 'Resonance · Hậu Kỳ': 'Resonance · Late',
  'Resonance Trung Kỳ': 'Resonance · Mid', 'Resonance Hậu Kỳ': 'Resonance · Late',
  'Độ Kiếp': 'Tribulation', '⚡ Độ Kiếp': '⚡ Tribulation',
  ...
  'Dung Hợp': 'Fusion', 'Nội Công': 'Internal Arts', 'Tâm Pháp': 'Mind Art',
  ...
  'Resonance Chân Quân': 'True Lord of Resonance', 'Starforged Chân Nhân': 'Sage of the Starforged',
  ...
  'Độ kiếp thành Starforged': 'Survive tribulation to Starforged', 'Đỉnh cao mọi hệ thống': 'Pinnacle of all systems',
  // NPC roles
  ...
  // Misc UI
  'Cấp →': 'Lv →', 'Bí Kíp →': 'Tomes →', '(Tối đa)': '(Max)',
  ...
  '+1 Đan Ascension Trial': '+1 Ascension Trial Pill', '+1 Đan Ascension Trial — sẽ tự dùng khi độ kiếp': '+1 Ascension Trial Pill — auto-used at tribulation',
  ...
  'Cắt Đứt Tai Mắt': 'Severing Eyes and Ears', 'Cuồng Binh Xung Trận': 'Berserkers Charge the Line', 'Liệt Hỏa Kỳ Lân': 'The Fire Qilin',
  ...
  'Tương Dương': 'Xiangyang', 'Ngũ Hành': 'Five Elements',
...
Object.assign(EXACT, {
  ...
  'Lục Đạo Kiếm Khí': 'Six-Way Sword Qi',
  ...
  'Tuyệt Hàn U Cốt Chưởng': 'Absolute-Cold Bone-Piercing Palm',
  'Thái Dương Bất Diệt Thần Công': 'Great-Yang Undying Divine Art',
  ...
  'Lục Dương Cực Viêm Chưởng': 'Six-Yang Extreme-Blaze Palm',
  'U Minh Sưu Hồn Đại Pháp': 'Nether Soul-Searching Art',
  'Vạn Cổ Độc Tôn Thần Công': 'Eternal Sole-Supreme Divine Art',
  'Nhuyễn Cốt Tan Gân Chưởng': 'Bone-Softening Tendon-Melting Palm',
  'Quỷ Ảnh Chỉ': 'Ghost-Shadow Finger',
  'Thiết Giáp Bất Hoại Thần Công': 'Iron-Armor Indestructible Divine Art',
  ...
  'Phóng ám khí độc — theo tầng Card Ám Khí.': 'Hurls poisoned hidden weapons — scales with the Hidden Weapons Card tier.',
  ...
  '5% đòn đánh phong mạch địch — Ascension cảnh 4.': "5% of attacks seal the foe's meridians — Ascension Lv 4.",
...
Object.assign(EXACT, {
  ...
  'mở kết hợp tự do, Cao cấp cần Resonance Trung, Thần cấp cần Resonance Hậu. Bí Kíp chủ yếu từ': 'unlocks free combination, Advanced arts need Mid Resonance, Godly arts need Late Resonance. Manuals come mainly from',
  ...
  'Tà Đạo Vực Nguyên Thủy': 'Corrupted Path of the Origin Rift',
...
Object.assign(EXACT, {
  ...
  'CHIÊU THỨC': 'SKILLS',
  'Ám Khí ·': 'Hidden Weapons ·',
  '☠ Huyết Ma Thôn Phệ (bí kíp)': '☠ Blood Demon Devour (secret manual)',
  ...
  'Luyện Khí': 'Qi Refining', 'Trúc Cơ': 'Foundation Establishment', 'Kết Đan': 'Core Formation',
  'Nguyên Anh': 'Nascent Soul', 'Hóa Thần': 'Deity Transformation', 'Luyện Hư': 'Void Tempering',
  'Hợp Thể': 'Body Integration', 'Đại Thừa': 'Mahayana',
...
Object.assign(EXACT, {
  ...
  'Thăng Giai (Nhận Bạch Mã)': 'Advance Tier (Claim White Steed)',
  'Kim Sư': 'Golden Lion',
  'Hỏa Kỳ Lân': 'Flame Qilin',
  'Thanh Long': 'Azure Dragon',
  'Bạch Hổ': 'White Tiger',
  'Chu Tước': 'Vermilion Bird',
  'Huyền Vũ': 'Black Tortoise',
  '☯ Đã đạt Thanh Long — đỉnh cao chiến thú thiên hạ!': '☯ Reached Azure Dragon — the pinnacle of war mounts!',
  ...
  'Ascension — Tu Luyện Nội Công': 'Ascension — Cultivate Inner Power',
  ...
  '☯ Starforged Cảnh — Instinct đã đạt cảnh giới tối thượng!': '☯ Starforged Realm — Instinct has reached its ultimate stage!',
  'Tịnh Tâm Tuyền': 'Tranquil Spring',
  'Instinct Channels — Đả Thông Huyệt Đạo': 'Instinct Channels — Unblock the Meridians',
  ...
  // Card (Tuyệt Học)
  'Card — 7 Tầng Cảnh Giới': 'Card — 7 Realm Stages',
...
Object.assign(EXACT, {
  ...
  '— ☁ PHI THĂNG · TÁN TIÊN —': '— ☁ ASCENSION · TRANSCENDENCE —',
  '⚥ Hình dáng tiên nhân': '⚥ Immortal appearance',
  'NAM': 'MALE',
  'NỮ': 'FEMALE',
  '🎨 Tiên Y (skin)': '🎨 Immortal Robes (skin)',
  'Đang mặc:': 'Currently wearing:',
  'ràng buộc Tộc đã phá bỏ, võ học toàn tự do, ngự kiếm phi hành +25% tốc độ.': 'the sect bond is broken, all martial arts are free to learn, and sword-flight speed is +25%.',
...
Object.assign(EXACT, {
  ...
  'TỨ CHÂU — ép tại Lò Rèn / Hỗn Độn Lò': 'FOUR PEARLS — socketed at the Forge / Bagua Forge',
